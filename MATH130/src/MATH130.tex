...
\subsection{TODO: Multiplying Matrices}
...
\begin{align}
\begin{bmatrix}
  \textcolor{neekiBlue}{P_{1,1}} & P_{1,2} \\
  P_{2,1} & P_{2,2}
\end{bmatrix}
 & =
\begin{bmatrix}
  \textcolor{neekiBlue}{a_{1,1}} & \textcolor{neekiBlue}{a_{1,2}} &
                                              \textcolor{neekiBlue}{a_{1,3}} \\
  a_{2,1} & a_{2,2} & a_{2,3}
\end{bmatrix}
\times
\begin{bmatrix}
  \textcolor{neekiBlue}{b_{1,1}} & b_{1,2} \\
  \textcolor{neekiBlue}{b_{2,1}} & b_{2,2} \\
  \textcolor{neekiBlue}{b_{3,1}} & b_{3,2}
\end{bmatrix}
\\
\textcolor{neekiBlue}{P_{1,1}} & \textcolor{neekiBlue}{= a_{1,1} \times b_{1,1} + a_{1,2} \times b_{2,1} +a_{1,3} \times b_{3,1}} \nonumber \\
P_{2,1} & = a_{2,1} \times b_{1,1} + a_{2,2} \times b_{2,1} + a_{2,3} \times b_{3,1} \nonumber \\
P_{1,2} & = a_{1,1} \times b_{1,2} + a_{1,2} \times b_{2,2} + a_{1,3} \times b_{3,2} \nonumber \\
P_{2,2} & = a_{2,1} \times b_{1,2} + a_{3,2} \times b_{2,2} + a_{2,3} \times b_{3,2} \nonumber
\end{align}
