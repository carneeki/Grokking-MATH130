...
\tableofcontents
\include{algebra/number-systems-types-of-numbers}
\include{algebra/number-systems-factorization}
\include{algebra/exponentials-logarithms}
\include{algebra/trigonometry}
\include{algebra/trig-identities}
\include{algebra/polynomials}
\include{algebra/absolute-values}
\include{algebra/inequalities}
\include{algebra/simultaneous-equations}
\include{algebra/matrices}
\include{algebra/parabolas}
\include{algebra/progressions}
\include{algebra/counting}
\include{calculus/introduction}
\include{calculus/functions-and-graphs}
\include{calculus/lines-and-limits}
\include{calculus/diff-intro}
\include{calculus/diff-maxima-minima}
\include{calculus/diff-of-logs}
\include{calculus/diff-of-trigs}
\include{calculus/diff-grokking-word-problems}
\include{calculus/diff-newtons-method}
\include{calculus/diff-lhopital}
\include{calculus/diff-practical-uses}
\include{calculus/integ-intro}
\include{calculus/integ-trapezoidal-rule}
\include{calculus/integ-simpsons-rule}
\include{calculus/integ-average-values-of-function}
\include{calculus/integ-practical-uses}
%-----------------------------------------------------------------------------%
%- Appendix ------------------------------------------------------------------%
%-----------------------------------------------------------------------------%
\include{appendices/glossary}
\include{appendices/calculus-proofs}
\include{appendices/differentiation-quickstart}
%-----------------------------------------------------------------------------%
%- Acknowledgments -----------------------------------------------------------%
%-----------------------------------------------------------------------------%
